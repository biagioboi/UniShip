...
<div class="page-wrapper default-theme sidebar-bg bg1">
    <nav id="sidebar" class="sidebar-wrapper overflow-auto custom-scrollbar">
        ...
        <div class="card info-card rounded-lg m-3 p-2">
            ...
            <div class="card-body">
                <!-- Name -->
                <h4 id="nomeUtente" class="card-title text-center font-weight-bold"></h4>
                <p id="numeroMatricola" class="card-text text-center font-italic"></p>
        ...
        <div id="progress-cicle" class="bg-white rounded-lg p-5 shadow m-3">
            ...
            <div class="progress mx-auto" data-value='0' id="percentoOreSvolte">
                ...
                <div
                    ...
                    <div class="h2 font-weight-bold"><span id="percentoTotale">0</span><sup
                            class="small">%</sup></div>
                </div>
            </div>
        ...
        <nav id="navbar" class="navbar navbar-expand-md navbar-light bg-white">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link primary-color" id="logoutBtn" href="#">Logout <i
                ...
                <ul class="nav nav-tabs nav-pills" role="tablist">
                    ...
                    <li class="nav-item">
                        <a id="pills-view-aziende" class="nav-link active" data-toggle="pill"
                           href="#pills-aziende" role="tab" aria-controls="pills-aziende"
                           aria-selected="true">
                    ...
                    <li class="nav-item">
                        <a id="pills-view-richiesteAzienda" class="nav-link active"
                           data-toggle="pill"
                    ...
                    <li class="nav-item">
                        <a id="pills-view-richiesteufficio" class="nav-link active"
                           data-toggle="pill"
...
<div class="toast-area" aria-live="polite" aria-atomic="true">
    ...
    <div class="toast-box">
        ...
        <div id="messaggioSuccesso" class="toast fade hide" role="alert" aria-live="assertive"
             aria-atomic="true" data-animation="true"
             data-delay="5000">
        ...
        <div id="messaggioErrore" class="toast fade hide" role="alert" aria-live="assertive"
             aria-atomic="true" data-animation="true"
             data-delay="5000">
            <div class="toast-header">
